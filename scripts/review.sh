...
echo "============================================================"
echo "RSI FRAMEWORK — SESSION REVIEW"
echo "============================================================"
echo ""
...
echo "  1. python3 scripts/rsi.py verify --changed-only"
echo "  2. python3 scripts/rsi.py loop"
echo "  3. python3 scripts/rsi.py dashboard"
echo "============================================================"
